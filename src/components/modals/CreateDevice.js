        ...
        <Modal.Body>
            <Form>
              <Dropdown className='mt-2 mb-2'>
                  <Dropdown.Toggle>{device.selectedType.name || "Вибирите тип"}</Dropdown.Toggle>
                  <Dropdown.Menu> 
               ...
               <Dropdown className='mt-2 mb-2'>
                  <Dropdown.Toggle>{device.selectedBrand.name || "Вибирите бренд"}</Dropdown.Toggle>
                  <Dropdown.Menu> 
